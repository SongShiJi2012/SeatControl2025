...
void ECFGL_Reset (void)
{
    ...
    /* 使能ECFGL时钟 */
    PCLK_CTL3_Peripheral_Clock_Enable(PCLK_CTL3_ECFGLCLKEN, TRUE);
}
...
/**
  ...
  * 返回 : 无。
  */
void ECFGL_Deinit (void)
{
    /* 复位ECFGL模块 */
    RST_CTL3_Peripheral_Reset_Enable(RST_CTL3_ECFGLRST, TRUE);
    RST_CTL3_Peripheral_Reset_Enable(RST_CTL3_ECFGLRST, FALSE);
    /* 使能ECFGL时钟 */
    PCLK_CTL3_Peripheral_Clock_Enable(PCLK_CTL3_ECFGLCLKEN, FALSE);
}
