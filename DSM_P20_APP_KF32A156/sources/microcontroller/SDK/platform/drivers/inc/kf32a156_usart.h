 ...
 *  Shanghai ChipON Micro-Electronic Co.,Ltd.                                 
 ******************************************************************************/
#ifndef KF32A156_USART_H_
#define KF32A156_USART_H_
...
/**
  * USART时钟极性
  */
#define USART_CPOL_FALL                 ((uint32_t)1<<USART_CTLR_SCKPS_POS)
#define USART_CPOL_RISE                 ((uint32_t)0<<USART_CTLR_SCKPS_POS)
#define CHECK_USART_CPOL(CPOL)          (((CPOL) == USART_CPOL_FALL) \
                                      || ((CPOL) == USART_CPOL_RISE))
...
#define USART_FLAG_IDLEIF               ((uint32_t)1<<USART_STR_IDLEIF_POS)
