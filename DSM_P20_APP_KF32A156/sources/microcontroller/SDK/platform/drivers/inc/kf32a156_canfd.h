...
******************************************************************************/
extern volatile uint8_t  CANFD_SCLK_MHZ;
extern volatile uint8_t  CANFD_HFCLK_MHZ;
/******************************************************************************
...
/*Avoid Cpu And Hardware Can Module Conflict timeout*/
#define RAM_STATE_LOOP_TIME     (0xFF)
/*Avoid Cpu And Hardware Can Module Conflict timeout*/
#define RAM_CONFLICT_LOOP_TIME  (0xFF)
/*clear interrupt flag timeout*/
#define CLEAR_FLAG_TIME         (0xFF)
/*hardware retransmit switch*/
#define HARDWARE_RETRANSMIT     STD_ON
/*hardware recover switch*/
#define HARDWARE_RECOVERY       STD_OFF
/*hardware filter switch*/
#define HARDWARE_FILTER         STD_OFF
/*HFCLK worksource switch*/
#define WORKSOURCE_HFCLK        STD_OFF
/*CANFD recover mode switch*/
#define CAN_BUSOFF_RECOVERY_INTERRUPT   STD_ON
/*CANFD Working clock frequency division*/
#define WORKSOURCE_DIVIDE_1     STD_ON
/*software retransmit switch*/
#define SOFACK_NORETRANSMIT     STD_OFF
/*ARBITRATE retransmit switch*/
#define ARBITRATE_SOFTRETRANSMIT  STD_ON
/*Send delay compensation*/
#define TRANSMIT_DELAY_CONPENSATION   STD_OFF
/*BETEN bit configuration switch*/
#define BETEN_DYNAMIC_CHANGE     STD_OFF

#define BETEN_RECEIVE_MAILBOX_CLEAN STD_OFF

#if (TRANSMIT_DELAY_CONPENSATION == STD_ON)
#define CONPENSATION_AUTO   STD_OFF
#if (CONPENSATION_AUTO  == STD_OFF)
#define CANFD6_TRANSMIT_DELAY_NS       (132U)
#define CANFD7_TRANSMIT_DELAY_NS       (92U)
#endif
#endif
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            volatile unsigned int RSMOD : 1;
            volatile unsigned int SILENT : 1;
            volatile unsigned int LBACK : 1;
            volatile unsigned int SLEEP : 1;
            volatile unsigned int ISOFDCANEN : 1;
            volatile unsigned int CANCKS : 2;
            volatile unsigned int CANEN : 1;
            volatile unsigned int TXR : 1;
            volatile unsigned int ATX : 1;
            volatile unsigned int RELRX : 1;
            volatile unsigned int RELF : 1;
            volatile unsigned int MBSIZE : 2;
            volatile unsigned int FULLRXEN : 1;
            volatile unsigned int ANSWEREN : 1;
            volatile unsigned int RXBSTA : 1;
            volatile unsigned int DOSTA : 1;
            volatile unsigned int TXBSTA: 1;
            volatile unsigned int TCSTA : 1;
            volatile unsigned int RXSTA : 1;
            volatile unsigned int TXSTA : 1;
            volatile unsigned int CERROR : 1;
            volatile unsigned int BOFF : 1;
            volatile unsigned int CANRMC : 7;
            volatile unsigned int CANFDEN : 1;
    ...
    union
    {
        ...
        struct
        {
        	volatile unsigned int CANBRP : 6;
        	volatile unsigned int SJW : 2;
        	volatile unsigned int TSEG1 : 4;
        	volatile unsigned int TSEG2 : 3;
        	volatile unsigned int SAM : 1;
        	volatile unsigned int BRSBRP : 6;
        	volatile unsigned int HTSEG1 : 4;
        	volatile unsigned int HTSEG2 : 3;
            unsigned int : 3;
    ...
    union
    {
        ...
        struct
        {
        	...
        	volatile unsigned int SOSFD : 5;
        	volatile unsigned int SFDEN : 1;
        	volatile unsigned int SFDMOD : 1;
        	volatile unsigned int DPRAMFEN: 1;
        } B;
    } CANFD_EROR;
    /* offset : 0x010.                              */
    union
    {
        ...
        struct
        {
        	volatile unsigned int TDCV : 7;
        	volatile unsigned int TDCOEN : 1;
        	volatile unsigned int TDCEN : 1;
        	volatile unsigned int TDCSAUTO : 1;
        	volatile unsigned int TDCS : 2;
        	volatile unsigned int TDCSR : 2;
        	volatile unsigned int TDCO : 2;
        	volatile unsigned int TDCVM : 7;
        	volatile unsigned int TEST0 : 1;
        	volatile unsigned int DESEL : 1;
        	volatile unsigned int AMCKDIV : 2;
        	volatile unsigned int TEST1 : 1;
        	volatile unsigned int TEST2 : 1;
        	volatile unsigned int TEST3 : 1;
        	volatile unsigned int TEST4 : 1;
        	volatile unsigned int TEST5 : 1;
        } B;
    } CANFD_CTLR2;

    /* offset : 0x014.                              */
    volatile unsigned int CANFD_MSKR;
    ...
    union
    {
        ...
        struct
        {
        	volatile unsigned int CANRXIE : 1;
        	volatile unsigned int CANTXIE : 1;
        	volatile unsigned int EAIE : 1;
        	volatile unsigned int DOVFIE : 1;
        	volatile unsigned int WUIE : 1;
        	volatile unsigned int ENIE : 1;
        	volatile unsigned int ALIE : 1;
        	volatile unsigned int BEIE : 1;
        	volatile unsigned int CTXDE : 1;
        	volatile unsigned int CRXDE : 1;
        	volatile unsigned int RXBSTAIE : 1;
        	volatile unsigned int TRGMBIE : 1;
        	volatile unsigned int BOFFIE : 1;
        	volatile unsigned int TDCFAILIE : 1;
        	volatile unsigned int ARBFAILIE : 1;
        	volatile unsigned int MOENDIE : 1;
        	volatile unsigned int CANRXIC : 1;
        	volatile unsigned int CANTXIC : 1;
        	volatile unsigned int EAIC : 1;
        	volatile unsigned int DOVFIC : 1;
        	volatile unsigned int WUIC : 1;
        	volatile unsigned int ENIC : 1;
        	volatile unsigned int ALIC : 1;
        	volatile unsigned int BEIC : 1;
            unsigned int : 1;
            volatile unsigned int TRANSMITIC : 1;
            volatile unsigned int MOENDIC : 1;
            volatile unsigned int TRGMBIC : 1;
            volatile unsigned int BOFFIC : 1;
            volatile unsigned int TDCFAILIC : 1;
            volatile unsigned int LPCANGPIOSEL0 : 1;
            volatile unsigned int FAILCLR: 1;
    ...
    union
    {
        ...
        struct
        {
        	volatile unsigned int CRC : 21;
            unsigned int : 7;
            volatile unsigned int STUFFCNT : 4;
    ...
    union
    {
        ...
        struct
        {
        	volatile unsigned int AMCKS : 2;
        	volatile unsigned int RXMUX : 7;
        	volatile unsigned int ST : 1;
        	volatile unsigned int FTCLKS : 1;
        	volatile unsigned int TSYN : 1;
        	volatile unsigned int MBNUM : 1;
        	volatile unsigned int MATCHMS : 1;
        	volatile unsigned int MBMSKEN : 1;
        	volatile unsigned int ARBMS : 1;
        	volatile unsigned int ARBSTART : 1;
        	volatile unsigned int LBSEL : 1;
        	volatile unsigned int BOFFREC : 1;
        	volatile unsigned int CKMODE : 1;
        	volatile unsigned int TRGNUM : 4;
        	volatile unsigned int TRGMBSEL : 7;
        	volatile unsigned int TRGMBEN : 1;
        } B;
    } CANFD_CTLR1;
    ...
    union
    {
        ...
        struct
        {
        	volatile unsigned int MATWINNER : 10;
        	volatile unsigned int MATSTA : 1;
        	volatile unsigned int ROPSTA : 1;
        	volatile unsigned int RELRXALL : 1;
        	volatile unsigned int IDSELEN : 1;
        	volatile unsigned int  RTRMEN: 1;
        	volatile unsigned int BETEN : 1;
        	volatile unsigned int ARBWINNER : 10;
        	volatile unsigned int ARBSTA0 : 1;
        	volatile unsigned int ARBSTA1 : 1;
        	volatile unsigned int TXCODE : 4;
...
typedef struct
{
	Canfd_MailboxHeaderType Can_MailboxHeader[1];
    uint8_t Sdu_Length;
...
void Can_m_FdClearFlag(const uint8_t Can_Controller_Index,const Can_Controller_InterruptType Can_Controller_Interrupt);
void Can_m_MailboxTrigerSet(const uint8_t Can_Controller_Index,const Can_MailboxNumType MailBox_Number,uint8_t Triger_Count);
...
void Can_m_ClearReceiveMailbox(const uint8_t Can_Controller_Index)
{
    ...
    for(uint8_t mailbox = Mailbox_1;mailbox< Mailbox_51;mailbox++)
    {
