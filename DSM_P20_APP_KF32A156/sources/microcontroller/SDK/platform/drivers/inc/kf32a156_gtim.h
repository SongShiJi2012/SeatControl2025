 ...
 *  Shanghai ChipON Micro-Electronic Co.,Ltd.                                 
 ******************************************************************************/
#ifndef KF32A156_GTIM_H_
#define KF32A156_GTIM_H_
...
#define GPTIM_TRIGGER_TRGSEL            ((uint32_t)0xA << GPTIM_CTL2_TXTS0_POS)
...
#define CCP_COMPARE_SELECT_4            ((uint32_t)0x3 << CCP_CTL2_PXASS0_POS)
#define CHECK_CCP_COMPARE_SELECT(ASS)   (((ASS) == CCP_COMPARE_SELECT_1) \
                                      || ((ASS) == CCP_COMPARE_SELECT_2) \
                                      || ((ASS) == CCP_COMPARE_SELECT_3) \
                                      || ((ASS) == CCP_COMPARE_SELECT_4))

/**
  * 选择TXCK引脚
  */
#define CCP_SEL_CK_PIN_TXCK              ((uint32_t)0)
#define CCP_SEL_CK_PIN_GTXCK1            ((uint32_t)1)
#define CCP_SEL_CK_PIN_GTXCK2            ((uint32_t)2)
#define CCP_SEL_CK_PIN_GTXCK3            ((uint32_t)3)
#define CHECK_CCP_TXCK_PIN(SEL)          (((SEL) == CCP_SEL_CK_PIN_TXCK) \
                                        ||((SEL) == CCP_SEL_CK_PIN_GTXCK1)\
                                        ||((SEL) == CCP_SEL_CK_PIN_GTXCK2)\
                                        ||((SEL) == CCP_SEL_CK_PIN_GTXCK3))
