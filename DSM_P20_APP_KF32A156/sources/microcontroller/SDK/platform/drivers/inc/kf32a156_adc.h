...
#ifndef KF32A156_ADC_H_
#define KF32A156_ADC_H_
...
#define ADC_EXTRA_TIME0P5				((uint32_t)1)
#define ADC_EXTRA_TIME1					((uint32_t)2)
#define ADC_EXTRA_TIME2					((uint32_t)3)
#define ADC_EXTRA_TIME4					((uint32_t)4)
#define ADC_EXTRA_TIME8				    ((uint32_t)5)
#define ADC_EXTRA_TIME16				((uint32_t)6)
#define ADC_EXTRA_TIME32				((uint32_t)7)
#define ADC_EXTRA_TIME64				((uint32_t)8)
#define ADC_EXTRA_TIME128				((uint32_t)9)
#define ADC_EXTRA_TIME256				((uint32_t)10)
#define CHECK_ADC_ADC_EXTRA_TIME(TIME)	((TIME) <= ADC_EXTRA_TIME256)
...
#define ADC_HPEXTERNALTRIG_FlexMUX_CH1  ((uint32_t)0x18<<ADC_CTL1_HCH0_POS)
#define ADC_HPEXTERNALTRIG_FlexMUX_CH2  ((uint32_t)0x19<<ADC_CTL1_HCH0_POS)
#define ADC_HPEXTERNALTRIG_FlexMUX_CH3  ((uint32_t)0x1A<<ADC_CTL1_HCH0_POS)
#define ADC_HPEXTERNALTRIG_FlexMUX_CH4  ((uint32_t)0x1B<<ADC_CTL1_HCH0_POS)
...
#define ADC_HPEXTERNALTRIG_ECFGL     	((uint32_t)0x27<<ADC_CTL1_HCH0_POS)
...
#define ADC_EXTERNALTRIG_FlexMUX_CH1    ((uint32_t)0x18<<ADC_CTL1_NCH0_POS)
#define ADC_EXTERNALTRIG_FlexMUX_CH2    ((uint32_t)0x19<<ADC_CTL1_NCH0_POS)
#define ADC_EXTERNALTRIG_FlexMUX_CH3    ((uint32_t)0x1A<<ADC_CTL1_NCH0_POS)
#define ADC_EXTERNALTRIG_FlexMUX_CH4    ((uint32_t)0x1B<<ADC_CTL1_NCH0_POS)
...
#define ADC_EXTERNALTRIG_ECFGL	    	((uint32_t)0x27<<ADC_CTL1_NCH0_POS)
...
void ADC_Deinit (ADC_SFRmap* ADCx);
