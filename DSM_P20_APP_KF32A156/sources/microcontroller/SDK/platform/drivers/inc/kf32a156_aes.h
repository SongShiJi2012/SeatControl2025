...
#ifndef KF32A156_AES_H_
#define KF32A156_AES_H_

#include "KF32A156.h"

#define AES_KEY_ADDR						((uint32_t)0x1FFEFC00)
 ...
 *  AES输入/输出寄存器
 * */
#define AES_DATA_REGISTER0					((uint32_t)0)
#define AES_DATA_REGISTER1					((uint32_t)1)
#define AES_DATA_REGISTER2					((uint32_t)2)
#define AES_DATA_REGISTER3					((uint32_t)3)
#define CHECK_AES_DATA_REGISTER(NUM)		((NUM) <= AES_DATA_REGISTER3)

/**
 *  AES密钥
 * */
#define AES_KEY_NUM0						((uint32_t)0)
#define AES_KEY_NUM1						((uint32_t)1)
#define AES_KEY_NUM2						((uint32_t)2)
#define AES_KEY_NUM3						((uint32_t)3)
#define CHECK_AES_KEY_NUM(NUM)				((NUM) <= AES_KEY_NUM3)
