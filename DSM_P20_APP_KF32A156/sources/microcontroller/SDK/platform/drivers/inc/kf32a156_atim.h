...
#ifndef KF32A156_ATIM_H_
#define KF32A156_ATIM_H_
...
#define ATIM_TRIGGER_TRGSEL             ((uint32_t)0x1 << ECCP_CTL2_TXTS0_POS)
...
#define CHECK_ATIM_TRIGGER_MODE(CMPNUM)	(((CMPNUM) == ATIM_TRIGGER_T1) \
									  || ((CMPNUM) == ATIM_TRIGGER_TRGSEL) \
									  || ((CMPNUM) == ATIM_TRIGGER_T5) \
									  || ((CMPNUM) == ATIM_TRIGGER_ECCPXCH1) \
									  || ((CMPNUM) == ATIM_TRIGGER_ECCPXCH2) \
									  || ((CMPNUM) == ATIM_TRIGGER_ECCPXCH3) \
									  || ((CMPNUM) == ATIM_TRIGGER_TXCK))
 ...
 * CH4的比较器关断源选择
 */
#define ECCP_CHANNEL_CMP0_ACTIVE           ((uint32_t)0)
#define ECCP_CHANNEL_CMP1_ACTIVE           ((uint32_t)1)
#define ECCP_CHANNEL_CMP2_ACTIVE           ((uint32_t)2)
#define ECCP_CHANNEL_CMP3_ACTIVE           ((uint32_t)3)
#define CHECK_CHANNEL4_SHOWDOWN_SEL(STATE) ((STATE) < 0x3)
...
void ATIM_Deinit (ATIM_SFRmap* ATIMx);
...
void ECCP_Channel_Zero_Detect_Enable (ECCP_SFRmap* ECCPx,uint32_t Channel, FunctionalState NewState);
void ECCP_Channel_Zero_Voltage_Config (ECCP_SFRmap* ECCPx,uint32_t Channel, uint32_t ZeroDetectVoltage);
void ECCP_Update_Dead_Zone_Register_Config(ECCP_SFRmap* ECCPx, FunctionalState NewState);
