 ...
 *  Shanghai ChipON Micro-Electronic Co.,Ltd.                                 
 ******************************************************************************/
#ifndef KF32A156_SPI_H_
#define KF32A156_SPI_H_
...
/**
  * SPI时钟边沿
  */
#define SPI_CKE_2EDGE                  ((uint32_t)0<<SPI_CTLR_SPICKE_POS)
#define SPI_CKE_1EDGE                  ((uint32_t)1<<SPI_CTLR_SPICKE_POS)
