 ...
 ******************************************************************************/
//º¯ÊýÉùÃ÷
extern void ADC_DRV_RegularChannelConfig(const uint32_t instance, const uint32_t channel, uint32_t Rank);
...
extern void ADC_DRV_InitScanMode(ADC_SFRmap *ADCx, uint8_t ScanNumber);
