...
extern void ADC_DMA_NormalChl_Init(ADC_SFRmap *ADCx, DMA_SFRmap *DMAx, uint32_t dmaChannel, void *ptr_Memory, uint16_t numTransfer, uint8_t bResetDMA);
extern void ADC_DMA_Int_Config(DMA_SFRmap *DMAx, uint32_t dmaChannel, InterruptIndex INT_Index, uint32_t Preemption, uint32_t SubPriority);
