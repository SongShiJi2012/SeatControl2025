...
set "SourceFolder=.\Appl_PaComfort_CtrlModel_ert_rtw\"
set "TargetFolder=..\..\..\..\DSM_P20_APP_KF32A156\sources\appl\PaSeatAdjustCtrl\"
set "FileName=Appl_PaComfort_CtrlModel"
