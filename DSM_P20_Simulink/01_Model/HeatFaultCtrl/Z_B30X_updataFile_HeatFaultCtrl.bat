...
set "SourceFolder=.\Appl_HeatFault_CtrlModel_ert_rtw\"
set "TargetFolder=..\..\..\DSM_P20_APP_KF32A156\sources\appl\HeatFaultCtrl\"
set "FileName=Appl_HeatFault_CtrlModel"
