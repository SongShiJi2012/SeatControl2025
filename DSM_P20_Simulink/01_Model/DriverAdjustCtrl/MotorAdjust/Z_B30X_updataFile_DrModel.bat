...
set "SourceFolder=.\Appl_DrMotorAdjust_CtrlModel_ert_rtw\"
set "TargetFolder=..\..\..\..\DSM_P20_APP_KF32A156\sources\appl\DriverAdjustCtrl\"
set "FileName=Appl_DrMotorAdjust_CtrlModel"
