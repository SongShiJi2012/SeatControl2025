...
set "SourceFolder=.\APPL_DriverFaultDetection_ert_rtw\"
set "TargetFolder=..\..\..\DSM_P20_APP_KF32A156\sources\appl\DriverFaultDetection\"
set "FileName=APPL_DriverFaultDetection"
