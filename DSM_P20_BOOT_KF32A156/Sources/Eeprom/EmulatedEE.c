...
static uint32_t CurValidPage[EN_EERPROM_SECTOR_NUM_MAX]      = {EE_PAGE_NONE,EE_PAGE_NONE};
static uint32_t CurValidPageInv[EN_EERPROM_SECTOR_NUM_MAX]   = {EE_PAGE_NONE,EE_PAGE_NONE};
static uint32_t CurTansferPage[EN_EERPROM_SECTOR_NUM_MAX]    = {EE_PAGE_NONE,EE_PAGE_NONE};
static uint32_t CurTansferPageInv[EN_EERPROM_SECTOR_NUM_MAX] = {EE_PAGE_NONE,EE_PAGE_NONE};
