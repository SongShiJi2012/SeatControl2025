...
// #define SYS_ARCTL_CPOPINT_POS           (11)
// #define SYS_ARCTL_CDIV_POS          	(12)
// #define SYS_ARCTL_CDMAHEC_POS           (13)
...
#define SYS_ARCTL_CPOPINT     ((uint32_t)0x03 << (SYS_ARCTL_CPOPINT_POS))
#define SYS_ARCTL_CDIV        ((uint32_t)0x03 << (SYS_ARCTL_CDIV_POS))
// #define SYS_ARCTL_CDMAHEC				((uint32_t)0x03<<(SYS_ARCTL_CDMAHEC_POS))
...
#define USART_STR_TFEIF_POS  (12) /* 与bit27比较 暂时未定开放哪个bit */
...
#define USART_STR_TFEIF1_POS (27) /* 与bit12比较 暂时未定开放哪个bit */
