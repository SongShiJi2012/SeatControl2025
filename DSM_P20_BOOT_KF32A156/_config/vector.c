...
#define Set_Heap_Size 0x1200   // default 0x100 by script file
...
#define Stack_Size 0x1000		// global variable with  initialization + global variable with no initialization + Heap + Stack must less than size of ram
